    ...
    <body>
        <?php
               ...
               if(isset($_SESSION['faculty']))
               {
                   ...
                   $sql = "Select CourseId,CourseName,Value,Semester from SelectedCourses where Semester='2' or Semester='4' or Semester='6'";
                    ...
                    for($x=1;$x<=5;$x++)
                    {
                        ...
                        ?>
                            ...
                            <option value=<?php echo $r['Value'] ?>  name=<?php $r['Value']?> ><?php echo $r['CourseName'] ?>(<?php echo "Semester"; echo$r['Semester'] ?>) </option>
